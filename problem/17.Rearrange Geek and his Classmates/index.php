<?php
	...
	$question = "<pre>Geek and his classmates are playing a prank on their Computer Science teacher. They change places every time the teacher turns to look at the blackboard. 
    ...
    echo "N = 5 <br/>".PHP_EOL;
    echo "a[] = $a <br/>".PHP_EOL;
    echo "Expect Output:  0 3 5 1 4 2 <br/>".PHP_EOL;
    echo "my output: ";
    for ($i = 0; $i<$n; $i++){
        echo $a[$i]." ";
    } 