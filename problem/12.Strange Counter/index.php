<?php
	...
	$question = "<pre>Bob has a strange counter. At the first second, it displays the number 3. Each second, the number displayed by the counter decrements by 1 until it reaches 1.<br/>
		The counter counts down in cycles. In next second, the timer resets to 2 x the initial number fir the prior cycle and continues counting down. The diagram below shows the counter values for each time t in the first three cycles:<br/>
			example: Time t = 4 marks the beginning of the second cycle. It is double the number displayed at the beginning of the first cycle: 2x3=6. This is also shown in the diagram in the Problem Statement above.</pre>";
