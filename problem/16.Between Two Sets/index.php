<?php
	...
	$question = "You will be given two arrays of integers and asked to determine all integers that satisfy the following two conditions:<br/>
...
For example, given the arrays a = [2,6] and b=[24,36], there are two numbers between them: 6 and 12. 6%2 = 0, 6%6 = 0, 26%6 = 0 and 36%6 = 0 for the first value. Similarly, 12%2 = 0, 12%2 = 0 and 24%12 = 0, 36%2 = 0.";
